...
// Returns the time in seconds when the highest meaningful raw analog value happened
// within the 1000 ms window.
// PEAK_MARGIN prevents tiny noise bumps from becoming a new peak.
